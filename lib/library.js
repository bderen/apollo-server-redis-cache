  ...
  _createClass(_class, [{
    ...
    value: function middleware() {
      ...
      return function (req, res, next) {
        ...
        var queryOperationName = req.body && req.body.operationName ? ':' + req.body.operationName : '';
        var queryVariables = req.body && req.body.variables ? ':' + (0, _hashSum3.default)(req.body.variables) : '';
        var packageVersion = ':' + _package.version;
        var cacheKey = _this.options.key + packageVersion + queryOperationName + queryVariables;

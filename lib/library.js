  ...
  _createClass(_class, [{
    ...
    value: function middleware() {
      ...
      return function (req, res, next) {
        ...
        var requestGetQuery = req.query.query && req.query.query ? (0, _hashSum3.default)(req.query.query) : 'Q';
        ...
        var cacheKey = _this.options.key + ':' + _package.version + ':' + queryOperationName + ':' + requestGetQuery + ':' + queryHash;
